        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <div className="flex gap-2">
              {[
                { id: 'stone', class: 'bg-[#703030]', label: 'แดง (Default)' },
                { id: 'teal', class: 'bg-[#2A939C]', label: 'ฟ้าอมเขียว' },
                { id: 'blue', class: 'bg-blue-700', label: 'น้ำเงิน' },
                { id: 'leaf', class: 'bg-emerald-700', label: 'เขียว' },
                { id: 'clay', class: 'bg-amber-700', label: 'ส้มอิฐ' },
                { id: 'slate', class: 'bg-slate-700', label: 'เทา' },
              ].map(theme => (
                <button
                  key={theme.id}
